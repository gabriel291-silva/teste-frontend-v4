...
export const EquipamentProvider = ({ children }) => {
  const [ equipamentSelected,setEquipamentSelected ] = useState([51.505, -0.09])
  const [ StateModal,SetStateModal] = useState(true)
  const [coodinateSelected,setCoodinateSelected] = useState([-19.272005,-46.043374])
  const equipaments = [
    {
  ...
  const equipmentPositionHistory = [
    ...
    },
    {
      ...
      positions: [
        ...
        {
          date: "2021-02-17T06:00:00.000Z",
          lat: -19.11156,
          lon: -45.940939,
        },
        {
          date: "2021-02-17T09:00:00.000Z",
          lat: -19.041961,
          lon: -45.863104,
        },
        {
  ...
  const findDataEquipament = ({id,equipamentID}) =>{
    const stateHistory = equipmentStateHistory.find((i) => i.equipmentId === id);
    const Model = equipmentModel.find((i) => i.id === equipamentID);
    const positionHistory = equipmentPositionHistory.find((i) => i.equipmentId === id);
  ...
  useEffect(()=>{
    findDataEquipament(equipamentSelected)
  },[equipamentSelected])

  return (
    <EquipamentContext.Provider value={{
      equipaments, 
      equipmentModel, 
